...
public class StreamEmployee
{
    ...
    System.out.println(date3);
        ...
        Employee e1=new Employee(1,"switha","doors",date2,"switha@gmail.com",2000);
        Employee e2=new Employee(2,"subi","release",date3,"subi@gmail.com",3000);
        ...
        ProjectEmployee pe1 = new ProjectEmployee(e1.getEmpId(),p1.getProjectId());
        ProjectEmployee pe2 = new ProjectEmployee(e2.getEmpId(),p2.getProjectId());
